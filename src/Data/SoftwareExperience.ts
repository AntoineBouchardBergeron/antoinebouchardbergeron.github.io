...
const podform3dExperience = (i18n: I18n) => (
  {
    items: [
      ...
      },
      {
        ...
        and were able to automate some of the `,
        architecture: ["FullStack"],
        framework: ["React", "Dotnet Core"],
        languages: ["C#", "TypeScript"],
      },
...
const AirTransatExperience = (i18n: I18n) => (
  {
    ...
    summary: t(i18n)`Helped the audit team with IT based audits`,
  ...
  items: [
    {
      ...
      description: t(i18n)`I was tasked with automating some of the repetitive tasks using VBS.`,
...
const onlineCV = (i18n: I18n) => ({
  ...
  summary: t(i18n)`Online Custom portfolio made using react and css`,
  title: t(i18n)`Online CV`,
  workplace: ""
}) as SoftwareExperience
